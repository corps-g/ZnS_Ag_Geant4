...
if __name__ == '__main__':
    ...
    wr = .12
    gperEvent = 10
    # the neutron and gamma counting the scintillation and Cherenkov noises 
    # results copy from the weight ratio optimization tests
    dirg = writer(lenz, wr, 'gamma', True, False, history, gperEvent)
    submit(dirg, lenz, wr)
    dirg = writer(lenz, wr, 'gamma', False, True, history, gperEvent)
    submit(dirg, lenz, wr)
