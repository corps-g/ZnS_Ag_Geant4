...
if __name__ == '__main__':
    ...
    dirn = writer(pmma, zsa, n, 'neutron', True, True, history, gperEvent)
    submit(dirn, pmma, zsa, n)
    dirg = writer(pmma, zsa, n, 'gamma', True, True, history, gperEvent)
    submit(dirg, pmma, zsa, n)
    dirg = writer(pmma, zsa, n, 'gamma', True, False, history, gperEvent)
    submit(dirg, pmma, zsa, n)
    dirg = writer(pmma, zsa, n, 'gamma', False, True, history, gperEvent)
    submit(dirg, pmma, zsa, n)        
